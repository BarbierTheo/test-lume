<nav class="w-screen lg:w-[20%] items-end">
    <!-- Format mobile -->
    <div class="drawer drawer-end lg:hidden flex justify-between p-4">
        <a href=""><img src="../../img/logosansm.png" class=" w-24 m-1"></a>
        ...
        <div class="drawer-side">
            ...
            <div class="menu bg-base-200 text-base-content min-h-full w-80 p-4">
                ...
                <a href="" class="self-center mb-8 mt-2"><img src="../../img/logosansm.png" alt="" class="w-24"></a>
    ...
    <aside class="bg-neutral-900/50 hidden lg:flex flex-col h-full p-4 items-center py-12 justify-between">
        <div class="flex flex-col gap-2">
            <a href="" class="self-center mb-16"><img src="../../img/logosansm.png" alt="" class="w-32"></a>
