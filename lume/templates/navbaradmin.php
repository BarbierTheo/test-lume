<nav class="w-screen lg:w-[20%] items-end lg:flex-shrink-0">
    ...
    <div class="drawer drawer-end lg:hidden flex justify-between p-4">
        <a href="/admin"><img src="../../img/logosansm.png" class="w-24 m-1"></a>
        ...
        <div class="drawer-side">
            ...
            <div class="menu bg-base-200 text-base-content min-h-full w-80 p-4">
                <a href="/admin" class="px-4 py-2 flex items-center gap-4 font-semibold cursor-pointer hover:bg-neutral-800 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);">
                        <path d="m21.743 12.331-9-10c-.379-.422-1.107-.422-1.486 0l-9 10a.998.998 0 0 0-.17 1.076c.16.361.518.593.913.593h2v7a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-4h4v4a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-7h2a.998.998 0 0 0 .743-1.669z"></path>
                    </svg>
                    Accueil
                </a>
                <a href="/admin/contact" class="px-4 py-2 flex items-center gap-4 font-semibold cursor-pointer hover:bg-neutral-800 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);">
                ...
                <a href="/admin/portfolio" class="px-4 py-2 flex items-center gap-4 font-semibold cursor-pointer hover:bg-neutral-800 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);">
                ...
                <a href="/admin/faq" class="px-4 py-2 flex items-center gap-4 font-semibold cursor-pointer hover:bg-neutral-800 rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);">
                ...
                <div class="flex flex-col mt-8 gap-2 justify-center items-center">
                    ...
                    <a href="/home" class="text-neutral-400 underline">Accès au site</a>
                </div>
    ...
    <aside class="bg-neutral-900/50 hidden lg:flex flex-col h-full p-4 items-center py-12 justify-start fixed w-[20%]">
        <div class="flex flex-col gap-2">
            <a href="/admin" class="self-center mb-16"><img src="../../img/logosansm.png" alt="" class="w-32"></a>
            <a href="/admin" class="px-4 py-2 flex items-center gap-4 font-semibold cursor-pointer hover:bg-neutral-800 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);">
                    <path d="m21.743 12.331-9-10c-.379-.422-1.107-.422-1.486 0l-9 10a.998.998 0 0 0-.17 1.076c.16.361.518.593.913.593h2v7a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-4h4v4a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1v-7h2a.998.998 0 0 0 .743-1.669z"></path>
                </svg>
