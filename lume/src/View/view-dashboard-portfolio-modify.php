                    ...
                    <dialog id="delete_modal_image<?= $key ?>" class="modal">
                        <div class="modal-box">
                            ...
                            <div class="flex justify-between">
                                ...
                                <div>
                                    <a href="/admin/portfolio/imgdelete?image=<?= $value['img_id'] ?>" class="w-fit btn !bg-red-600/30">Supprimer</a>
                                </div>
                            </div>
                        </div>
                    </dialog>
    ...
    <dialog id="delete_modal" class="modal">
        <div class="modal-box">
            ...
            <div class="flex justify-between">
                <a href="" class="w-fit btn">Annuler</a>
                <div>
                    <a href="/admin/portfolio/delete?projet=<?= $_GET['projet'] ?>" class="w-fit btn !bg-red-600/30">Supprimer</a>
                </div>
            </div>
        </div>
