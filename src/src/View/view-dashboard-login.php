...
<main class="min-h-screen w-screen flex flex-col lg:flex-row justify-center items-center">
    ...
    <section class="bg-neutral-900 lg:w-[40%] max-w-[30rem] w-[80%] p-4 lg:p-8 rounded-lg shadow-md flex flex-col gap-4">
        ...
        <label class="input validator w-full">
            ...
            <input
                ...
                minlength="3"
                maxlength="30"
                title="Seulement des lettres, des nombres et des tirets" />
        </label>
        ...
        <label class="input validator w-full">
            ...
            <input
                ...
                minlength="8"
                pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                title="Doit contenir plus de 8 caractères" />
        </label>
