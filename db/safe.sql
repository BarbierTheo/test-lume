...
--
-- Hôte : db
-- Généré le : mar. 20 mai 2025 à 15:26
...
(15, 'Pourquoi faire appel à un architecte pour mon projet ?', '<div>\r\n<pre><code><em>Un architecte apporte son expertise pour cr&eacute;er un projet esth&eacute;tique, fonctionnel et conforme aux normes. Il optimise les co&ucirc;ts, g&egrave;re le respect des d&eacute;lais et supervise les, garantissant la qualit&eacute; et la s&eacute;curit&eacute; du chantier. En plus, il veille &agrave; la valorisation de votre bien immobilier &agrave; travers une conception r&eacute;fl&eacute;chie et unique.</em></code></pre>\r\n</div>', '2025-05-14 23:12:48'),
...
(35, '../../img/projects/29/682b57d156819_Concours.webp', NULL, 4, 29);
...
--
ALTER TABLE `lume_img`
  MODIFY `img_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT pour la table `lume_project`
--
ALTER TABLE `lume_project`
  MODIFY `project_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
